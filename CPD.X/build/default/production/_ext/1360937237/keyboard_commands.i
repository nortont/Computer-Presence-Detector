...
extern volatile __bit  EPCONDIS __at(0x7A9B);
...
extern volatile __bit  EPHSHK __at(0x7A9C);
...
extern volatile __bit  EPINEN __at(0x7A99);
...
extern volatile __bit  EPOUTEN __at(0x7A9A);
...
extern volatile __bit  EPSTALL __at(0x7A98);
...
static KEYBOARD_INPUT_REPORT inputReport @0x240;

static volatile KEYBOARD_OUTPUT_REPORT outputReport @0x248;
...
switch(command) {
case 0:
noKeyWinCodes(inputReport.keys);
break;

case 1:
lockKeyWinCodes(inputReport.keys);
command = 0;
break;
default:
break;
...
inputReport.modifiers.bits.rightGUI = 0;
keys[0] = 0x00;
keys[1] = 0x00;
keys[2] = 0x00;
keys[3] = 0x00;
