...
countSeconds++;
if(preWarnTimeElepased && !locked){PORTCbits.RC4 = !PORTCbits.RC4;}

if (!preWarnTimeElepased && countSeconds > 10) {

countSeconds = 0;
preWarnTimeElepased=1;

}
else if (preWarnTimeElepased && countSeconds > 10) {

countSeconds = 0;
locking = 1;

}
else if (locked && countSeconds > 600){
